...
use scsv_chain::{BitcoindChain, NullifierIndex, PublicationChain};
...
/// Verify a whole bundle against the chain. `min_confirmations` is the depth
/// every ancestry nullifier must have (S6; production uses ≥ 6).
